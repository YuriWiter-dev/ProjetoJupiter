  ...
  <div Class="container">
    <div class="row">
      <div class="col-12 text-center my-5">
        <h1 class="display-3"> Projetos de <?php echo formataNomeArea($areaAtuacao); ?></h1>
          <br>
        <div class="row">
            <div class="col-9 container">
               <?php 
                    $r = pesquisarPorAreaPro($areaAtuacao);
                    ...
                    <?php
                        while ($row = mysqli_fetch_array($r)){
                            ...
                            $s = selecionarPorLoginP($pesquisador);
        ...
        <!-- Criando os links para os projetos -->
                            <li class="list-group"> 
                                <a href="apresentacaoPro.php?c=<?php echo $cod;?>"> <h4><?php echo $titulo; ?> </h4> </a>
                                <span><?php echo $descricao;?> </span>
                                <span> <p align='right'><?php echo $nomePesquisador." ".$ano;?> </p> </span>
                            </li>
                            <hr>
     ...
     <?php
            ...
            ?>
                <li class="list-group"> 
                    <span> Ainda não há projetos de <?php echo formataNomeArea($areaAtuacao); ?> cadastrados.</span>
                </li>
     <?php
        } // fim do else  
      ?>
